...
def search():
    ...
    return render_template('search.html', title='Search books', login_form=form,
                           search_form=search_form)


@my_blueprint.route('/books_search', methods=['GET', 'POST'])
def books_search():
    global GLOBAL_JSON
    global GLOBAL_REQUEST
    global GLOBAL_LOGIN
...
@my_blueprint.route('/<request>/<id2>/', methods=['GET', 'POST'])
def add(request, id2):
    global GLOBAL_JSON
    global GLOBAL_REQUEST
    global GLOBAL_LOGIN
...
@my_blueprint.route('/library', methods=['GET', 'POST'])
def library():
    global GLOBAL_JSON
    global GLOBAL_REQUEST
    global GLOBAL_LOGIN
...
@my_blueprint.route('/user', methods=['GET', 'POST'])
def user():
    global GLOBAL_LOGIN
...
@my_blueprint.route('/history', methods=['GET', 'POST'])
def history():
    global GLOBAL_LOGIN
...
@my_blueprint.route('/add_hist/<title>/<authors>/<href>', methods=['GET', 'POST'])
